...
interface LoaiDeXuatStore {
  ...
  setFilters: (data: Partial<LoaiDeXuatStore['filters']>) => void
  reset: () => void
}
...
export const useLoaiDeXuatStore = create<LoaiDeXuatStore>()(
  persist(
    (set) => ({
      columnWidths: {},
