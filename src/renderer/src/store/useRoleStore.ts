...
export const INITIAL_ROLE_VISIBLE_COLUMNS = [
    'stt',
    'ql_vai_tro_ten',
    'ql_vai_tro_mo_ta',
    'ql_vai_tro_ngay_tao',
...
export const useRoleStore = create<RoleStore>()(
    persist(
        (set) => ({
            ...
            visibleColumns: new Set(INITIAL_ROLE_VISIBLE_COLUMNS),
        ...
        }),
        {
            ...
            merge: (persistedState: any, currentState) => {
                return {
                    ...currentState,
                    ...persistedState,
                    visibleColumns: new Set(persistedState.visibleColumns || INITIAL_ROLE_VISIBLE_COLUMNS),
